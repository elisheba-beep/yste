...
export default function SquareCard({ image, text, alt, onClick }: SquareCardProps) {
  return (
    <div className="w-1/5 h-64 rounded-2xl border-gray-300 border-2 my-12 mx-3 hover:cursor-pointer hover:shadow-2xl shadow-gray-800 overflow-hidden flex-none" onClick={onClick}>
